$(document).ready(function () {
    ...
    //height and width
    const retention_height = 400 - retention_margin.top - retention_margin.bottom;
    const retention_width = 600 - retention_margin.left - retention_margin.right;
