...
<div class="row pt-3">
  <div class="col-sm-12 col-md-5">
    ...
    <p>Student enrolment is influenced by four main drivers: demographics, migration, public-independent
      transition, and course load retention. All values are reported in funded <a
        href="https://studentsuccess.gov.bc.ca/glossary#79" target="_blank" class="fte_defin">Full-Time Equivalent (FTE)</a>.</p>
    <div class="cta_container mt-5">
      <a class="btn ctaBtn btn-lg mr-3" href="#enrolment_model">EXPLORE</a>
      <a class="btn ctaGhost btn-lg" href="#booklet">ENROLMENT REPORT</a>
    </div>
    ...
    <div id='model_control'>
      ...
      <div class="controlSection">
        ...
        <a class="ghostBtn reportBtn"
              href="https://studentsuccess.gov.bc.ca/provincial-results"
    ...
    <div id="demo_control">
      ...
      <div id="demoModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content" style="top: 198px;">
...
<div class="row">
  <div class="col-md-8 mx-auto driver_section">
    ...
    <p>The retention driver provides an indication if students are moving from a full course load to a partial
      ...
      succession or repeating a grade. If net retention is positive, this could mean that there is an influx of
      students in the system compared to the previous year, students could be increasing their course loads compared
      to the previous year, or students are not advancing grades or graduating as expected. If net retention is
      negative, this means that the student population could be declining compared to the previous year, students
      could be decreasing their course load compared to the previous year, or students are graduating and advancing
      as expected. Comparing a school districts retention rate trend to the provincial retention rate trend can help
...
<div class="row">
  <div class="col-md-8 mx-auto  mb-5 text-center driver_section">
    ...
    <h5>For more data at the provincial and district levels. Please view the contextual reports on the student success website.</h5>
    <a class="btn ctaBtn btn-lg" href="https://studentsuccess.gov.bc.ca/school-district/099/report/contextual-information" target="_blank">VIEW REPORTS</a>
  </div>
</div>
</div>
</div>
