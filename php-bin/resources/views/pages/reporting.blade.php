...
<div class="reporting-page">
	<div style="position:relative;">
		...
		<img src="/img/bg-images/r-a-top-banner.png" alt="image of hex boxes" style="position:absolute; z-index:-1; width:100%;">
		...
		<div style="padding-top:14rem; margin-bottom:5rem;" class="reports-heading">
				<img src="/img/arrorw-down.png" alt="downward arrow" style="position: absolute; top: 91%;left: 49%;line-height: 34px;">
		</div>
	</div>
	...
	<div class="center" style="margin: 4rem 0rem;"><p>The following reports are available in PDF format and highlight the latest inquiries from the following categories. <strong><a  href="mailto:educ.systemperformance@gov.bc.ca">Contact us</a></strong> if you would<br>
	  &nbsp;&nbsp;&nbsp;like to request additional information, or if you are looking for previously annual reports published prior to 2023.</p>
	</div>
	<div class="row">
...
<!-- sls -->
		<!-- <div class="r-n-a-panel panel panel-default col-xs-12 col-sm-4 col-lg-4">
			<div class="panel-heading">
				<a id="sls-constructs" href="https://studentsuccess.gov.bc.ca/sls/construct-guide.html" target="_blank">
					<img alt="" class="toc-chart-thumbnail" src="/img/charts/slscConstructs-thumb.png" style="width:302px;height:221px;"/>
				</a>
			</div>
			<div class="panel-body">
				<p id="sconstructs"class="panel-body-title dark-blue">SLS Construct Guide</p>
				<a id="sconstructs" href="https://studentsuccess.gov.bc.ca/sls/construct-guide.html" target="_blank">
					<p>Student Learning Survey Construct Guide</p>
				</a>
			</div>
		</div> -->
				<div class="r-n-a-panel panel panel-default col-xs-12 col-sm-12 col-lg-4">
