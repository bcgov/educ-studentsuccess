<section class="slide" id="about">
	<div class="slide-content">
		...
		<img src="/img/bg-images/left-hexpattern.png" alt="image of a gray banner" style="position:absolute; right:96px; top:46px;">
		<img src="/img/bg-images/left-hexpattern.png" alt="image of a gray banner" style="position:absolute;left:96px; top:46px;">
			<div class="restrain">
				...
				<img class="green-bar" style="margin-left: 0px; margin-top: -33px; position: relative;" src="{{URL::to('/')}}/img/green-bar-2.png" alt=""/>
				<br>
...
<div style="position:relative;">
	<img src="/img/bg-images/BCmapSuccessHomeCropped.png" alt="image of a map of B.C." style="position:absolute; top:119px">
	<!-- <div class="mid-sec-bk" style="background-image: url('{{URL::to('/')}}/img/bg-images/BCmapSuccessHomeCropped.png');background-repeat: no-repeat;">	 -->
		<div class="restrain">
			...
			<img class="green-bar" style="margin-left: 4px; margin-top: 7px; position: relative;" src="{{URL::to('/')}}/img/green-bar-2.png" alt=""/>
		</div>
		<div class="row frontPage-charts">
			...
			<div class="col-md-2 frontPage-radio" style="margin-top:67px;">
				<ul style="display: inline-block;" >
					...
					<li style="list-style: none;"><input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="enrollment-info-check" > Enrolment</li>
					...
					<li style="list-style: none;"><input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="grade-4-7-fsa-check"> Foundation Skills <br><span style="margin-left: 16px;">Assessment</span></li>
					<li style="list-style: none;"><input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="provincial-assessments-check"> Graduation Assessment</li>
	...
	<div class="restrain" style="position: relative;"><a class="btn btn-primary btn-lg" href="/reporting">LEARN MORE  +</a></div>
  ...
  <div class="light-gray-bg" style="margin-bottom: -20px;">
    <div class="restrain" style="padding-bottom: 50px;">
	  <ul class="light-blue thirds">
		  ...
		  <a href="/ahawd"><img class="" style="padding-top: 20px" src="{{URL::to('/')}}/img/rna-image.png" alt=""/></a>
		  <p class="tp body-color">The annual How Are We Doing? report published by the Ministry of Education and Child Care providing data about the public school system's performance in serving students of Aboriginal ancestry.</p>
	  ...
	  <ul class="light-blue thirds" style="padding-left: 14px;">
		...
		<img class="green-bar" style="margin:0px; float: left" src="{{URL::to('/')}}/img/green-bar-2.png" alt=""/>
		<a href="{{URL::to('/')}}/childcare"><img class="" style="padding-top: 20px" src="{{URL::to('/')}}/img/childcare-image.png" alt=""/></a>
		<p class="tp body-color">Program and services data to support parents and caregivers with a variety of quality options and costs associated with child care.</p>
	    <p style="padding-top:8px"><a class="btn btn-primary btn-lg get-in-touch" href="{{URL::to('/')}}/childcare">LEARN MORE  +</a></p>
	  </ul>
	  <ul class="light-blue thirds" style="padding-left: 30px;">
	  	<h3 class="dark-blue tp">Continue the Conversation</h3>
		<img class="green-bar" style="margin:0px; float: left" src="{{URL::to('/')}}/img/green-bar-2.png" alt=""/>
		<a href="mailto:educ.systemperformance@gov.bc.ca"><img class="" style="padding-top: 20px" src="{{URL::to('/')}}/img/get-in-touch-image.png" alt=""/></a>
	    ...
	    <p style="padding-top: 4px"><a class="btn btn-primary btn-lg get-in-touch" href="mailto:educ.systemperformance@gov.bc.ca" style="margin-top:35px">GET IN TOUCH  +</a></p>
	  </ul>
	</div>
  </div>
