<div id="header">
  <div class="restrain">
    ...
    <div id="language-switcher">
      <a class="{{ App::getLocale() }} language-switcher<?php if (App::isLocale('en')) print ' active'; ?>" href="{{ url('lang/en') }}">English</a> 

      {{-- This `if` condition is temporary while the site is being translated. --}}
      @if (!App::environment('production', 'staging'))
        <a class="{{ App::getLocale() }} language-switcher<?php if (App::isLocale('fr')) print ' active'; ?>" href="{{ url('lang/fr') }}">Français</a>
      @else
...
<nav id="secondary-nav" class="contracted">
  ...
  <ul class="secondary-nav-container restrain white">
    ...
    <li><a class="secondary-nav-link" href="/all/school-districts">{{ trans('esdr2.districts_heading') }}</a></li>
    <li><a class="secondary-nav-link" href="/all/cities">{{ trans('esdr2.cities_heading') }}</a></li>
