...
@if ($report_slug == 'prov-exams')
  ...
  <p class="white report-meta">{{ trans('esdr2.prov_exams_copy1') }}</p>
  <ul class="white" style="margin-left: 16px;">
    <li style="list-style: square;">{{ trans('esdr2.prov_exams_copy2') }}</li>
    <li style="list-style: square;">{{ trans('esdr2.prov_exams_copy3') }}</li>
  </ul>
  <p class="white report-meta" style="margin-top: 1rem;"><a target="_blank" href="https://curriculum.gov.bc.ca/graduation-info">{{ trans('esdr2.prov_exams_link1') }}</a></p>
  <p class="white report-meta">For a more complete set including additional years and subpopulations view the open data for <a href="https://catalogue.data.gov.bc.ca/dataset/bc-schools-examinations-results">Provincial Exams</a> </p>
@endif
